    ...
    const contactInfo = [
        {
            icon: Mail,
            title: 'Email Us',
            details: 'info@vexalixtechnology.com',
            link: 'mailto:info@vexalixtechnology.com',
        },
        {
            icon: Phone,
            title: 'Call Us',
    ...
    return (
        <section className="relative">
            ...
            <div className="relative bg-black overflow-hidden">
                ...
                {/* Gradient Orbs */}
                <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#833DFA]/20 rounded-full blur-[120px]"></div>
                <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-[#833DFA]/20 rounded-full blur-[120px]"></div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full mb-8">
                                <MessageSquare className="w-4 h-4 text-[#833DFA]" />
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 mb-12">
                                {contactInfo.map((item, index) => (
                                    <a
                                        key={index}
                                        href={item.link || '#'}
                                        className="group bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-[#833DFA]/50 transition-all duration-300"
                                    >
                                        <item.icon className="w-6 h-6 text-[#833DFA] mb-3 group-hover:scale-110 transition-transform" />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid sm:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-black border border-zinc-800 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-[#833DFA] transition-colors"
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className="w-full px-4 py-3 bg-black border border-zinc-800 rounded-xl text-white focus:outline-none focus:border-[#833DFA] transition-colors"
                                    >
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        rows={4}
                                        className="w-full px-4 py-3 bg-black border border-zinc-800 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-[#833DFA] transition-colors resize-none"
