            ...
            <div className="relative z-10   flex flex-col lg:flex-row">
                ...
                <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-12 py-20 lg:py-0">
                    <div className="max-w-2xl w-full">
                        ...
                        <div className="mb-10 ">
                            <h1 className={`text-display font-semibold mb-6 leading-[1.1] tracking-tight transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                                <div className="relative mb-3">
                                    <span className="text-transparent  bg-clip-text bg-gradient-to-r from-[#00d0ff] via-[#00d0ff] to-[#00d0ff] animate-gradient-x drop-shadow-[0_0_50px_rgba(0,208,255,0.5)]">Technology.</span>
                                </div>
                                <div className="relative mb-3">
                                    <span className="relative inline-block">
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d0ff] via-[#00d0ff] to-[#00d0ff] animate-gradient-x drop-shadow-[0_0_50px_rgba(0,208,255,0.5)]">
                                            Innovation.
                                        </span>
                                        <div className="absolute -inset-1 bg-gradient-to-r from-[#00d0ff] via-[#00d0ff] to-[#00d0ff] blur-2xl opacity-20 -z-10"></div>
                                    </span>
                                </div>
                        ...
                        <div className={`grid grid-cols-3  gap-3 mb-10 transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                            <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-[#00d0ff] via-[#00d0ff] to-[#00d0ff] text-white text-xs font-semibold rounded-xl shadow-[0_0_30px_rgba(0,208,255,0.4)] border border-[#00d0ff]/30">
                        ...
                        <div className={`flex md:flex-row flex-col  gap-4 transition-all duration-1000 delay-400 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                            ...
                            <Link href="/services" className="group relative px-6 py-3 bg-white/5 backdrop-blur-md text-white rounded-full text-button border-2 border-white/20  text-center hover:border-[#00d0ff]/50 hover:scale-105 transition-all duration-300 hover:shadow-[0_0_40px_rgba(0,208,255,0.4)] overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-r from-[#00d0ff]/10 via-[#00d0ff]/10 to-[#00d0ff]/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                <span className="relative z-10 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-[#00d0ff] group-hover:to-[#00d0ff] transition-all">
                                    Our Services
                                </span>
                            </Link>
                        </div>
                ...
                <div className="flex-1 relative min-h-[400px] lg:min-h-screen">
                    ...
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-[#00d0ff]/10 rounded-full blur-3xl animate-pulse"></div>
                        <div className="absolute bottom-1/4 right-1/3 w-48 h-48 bg-[#00d0ff]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
                    </div>
                </div>
            </div>
