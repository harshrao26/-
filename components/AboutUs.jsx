            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                ...
                <div className="mb-24">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            ...
                            { name: 'Healthcare', icon: Stethoscope, color: 'from-red-500 to-blue-500' },
                            { name: 'Retail', icon: ShoppingCart, color: 'from-orange-500 to-yellow-500' },
                            { name: 'E-commerce', icon: ShoppingCart, color: 'from-blue-500 to-blue-500' },
                ...
                {/* <div>
                    ...
                    <div className="relative">
                         <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-blue-500 via-blue-500 to-blue-500 hidden lg:block"></div>
                                ...
                                >
                                    ...
                                    <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 hover:bg-zinc-800 hover:border-zinc-700 transition-all duration-500 group">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                            <span className="inline-block px-6 py-2 bg-gradient-to-r from-blue-500 to-blue-500 text-white font-semibold text-2xl rounded-2xl mb-4 md:mb-0">
                                                {milestone.year}
                                            </span>
