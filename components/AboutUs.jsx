...
export default function AboutUs() {
    ...
    return (
        <section className="relative bg-black overflow-hidden">
            ...
            {/* Gradient Accents */}
            <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#00d0ff]/10 rounded-full blur-[120px]"></div>
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#00d0ff]/10 rounded-full blur-[120px]"></div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
                    {stats.map((stat, index) => (
                        ...
                        >
                            <stat.icon className="w-10 h-10 text-[#00d0ff] mx-auto mb-4 group-hover:scale-110 transition-transform" />
                ...
                <div className="mb-24">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            { name: 'IT & Technology', icon: Laptop, color: 'from-[#00d0ff] to-cyan-500' },
                            { name: 'Finance', icon: Banknote, color: 'from-green-500 to-emerald-500' },
                            { name: 'Healthcare', icon: Stethoscope, color: 'from-red-500 to-[#00d0ff]' },
                            { name: 'Retail', icon: ShoppingCart, color: 'from-orange-500 to-yellow-500' },
                            { name: 'E-commerce', icon: ShoppingCart, color: 'from-[#00d0ff] to-[#00d0ff]' },
                            { name: 'Education', icon: GraduationCap, color: 'from-[#00d0ff] to-indigo-500' },
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {team.map((member, index) => (
                            ...
                            >
                                ...
                                <div className="text-[#00d0ff] font-semibold mb-3">{member.role}</div>
                ...
                {/* <div>
                    ...
                    <div className="relative">
                         <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-[#00d0ff] via-[#00d0ff] to-[#00d0ff] hidden lg:block"></div>
                        ...
                        <div className="space-y-8">
                            {milestones.map((milestone, index) => (
                                ...
                                >
                                     <div className="absolute left-6 top-6 w-5 h-5 bg-[#00d0ff] rounded-full border-4 border-black hidden lg:block"></div>
                                    ...
                                    <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 hover:bg-zinc-800 hover:border-zinc-700 transition-all duration-500 group">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                            <span className="inline-block px-6 py-2 bg-gradient-to-r from-[#00d0ff] to-[#00d0ff] text-white font-semibold text-2xl rounded-2xl mb-4 md:mb-0">
                                                {milestone.year}
                                            </span>
