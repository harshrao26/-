    ...
    const services = [
        {
            ...
            bgGradient: 'from-[#00d0ff]/10 to-cyan-500/10',
        ...
        },
        {
            ...
            bgGradient: 'from-[#00d0ff]/10 to-[#00d0ff]/10',
            pricing: 'Custom Quote',
            deliveryTime: 'Project Based',
        ...
        },
        {
            ...
            gradient: 'from-[#00d0ff] to-rose-500',
            bgGradient: 'from-[#00d0ff]/10 to-rose-500/10',
            pricing: 'Custom Quote',
            deliveryTime: 'Project Based',
            slug: 'ui-ux-design',
        },
        {
            ...
            gradient: 'from-cyan-500 to-[#00d0ff]',
            bgGradient: 'from-cyan-500/10 to-[#00d0ff]/10',
            pricing: 'Custom Quote',
        ...
        },
        {
            ...
            gradient: 'from-indigo-500 to-[#00d0ff]',
            bgGradient: 'from-indigo-500/10 to-[#00d0ff]/10',
            pricing: 'Custom Quote',
            deliveryTime: 'Project Based',
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {process.map((item, index) => (
                            ...
                            >
                                ...
                                {/* Icon */}
                                <div className="inline-flex w-14 h-14 bg-gradient-to-br from-[#00d0ff] to-[#00d0ff] rounded-2xl items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-lg">
                ...
                <div className="mb-24">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {benefits.map((benefit, index) => (
                            ...
                            >
                                <benefit.icon className="w-12 h-12 text-[#00d0ff] mx-auto mb-4 group-hover:scale-110 transition-transform" />
