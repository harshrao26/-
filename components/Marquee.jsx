...
export default function MarqueeV1() {
    const technologies = [
        { icon: Code2, name: 'Web Development', gradient: 'from-[#833DFA] to-indigo-600' },
        { icon: Database, name: 'Database Management', gradient: 'from-[#833DFA] to-[#833DFA]' },
        { icon: Cloud, name: 'Cloud Solutions', gradient: 'from-cyan-600 to-[#833DFA]' },
        ...
        { icon: Globe, name: 'Digital Transformation', gradient: 'from-[#833DFA] to-[#833DFA]' },
        { icon: Smartphone, name: 'Mobile Apps', gradient: 'from-green-600 to-emerald-600' },
        { icon: Server, name: 'Server Management', gradient: 'from-rose-600 to-[#833DFA]' },
        { icon: Lock, name: 'Data Security', gradient: 'from-indigo-600 to-[#833DFA]' },
        ...
        { icon: Layers, name: 'Microservices', gradient: 'from-[#833DFA] to-[#833DFA]' },
    ];
